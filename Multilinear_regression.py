...
# Compute single prediction and loop over (without vectorization)
...
# Vectorization using vector dot product
...
m,_ = X_train.shape
for i in range(m):
    print(f"\nprediction: {np.dot(X_train[i], w_final) + b_final:0.2f}, target value: {y_train[i]}")
